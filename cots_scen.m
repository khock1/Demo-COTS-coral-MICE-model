...
scenario=struct();
switch scen
    case 1%explore scenarios with varying effects of fish predators on COTS
    ...
    case 2%explore scenarios with varying effects of invertebrate predators on COTS juveniles
    ...
    case 3%explore scenarios with varying effects of control program removal on COTS juveniles
        scenario.inv_biomassavg=p.INV_BIOMASSAVG;%B line
        scenario.inv_mortoncots0=p.INV_MORTONCOTS0;%F I
        scenario.lfp_effectoffgc=p.LFP_EFFECTOFFGC;%p tilde tilde
        scenario.cots_largpred1=p.COTS_LARGPRED1;%p 1
